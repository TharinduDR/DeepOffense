...
train = pd.read_csv('examples/bengali/data/trac2_iben_train.csv', sep=",",  quoting=csv.QUOTE_NONE,  encoding="utf-8-sig", engine="python")
train = train.rename(columns={'Text': 'text', 'Sub-task A': 'labels'}).dropna()
train = train[['text', 'labels']]

dev = pd.read_csv('examples/bengali/data/trac2_iben_dev.csv', sep=",",  quoting=csv.QUOTE_NONE,  encoding="utf-8-sig", engine="python")
dev = dev.rename(columns={'Text': 'text', 'Sub-task A': 'labels'}).dropna()
dev = dev[['text', 'labels']]

test = pd.read_csv('examples/bengali/data/trac2_iben_test.csv', sep=",",  quoting=csv.QUOTE_NONE,  encoding="utf-8-sig", engine="python")
